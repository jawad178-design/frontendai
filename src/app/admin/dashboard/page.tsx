    ...
    <div className="min-h-screen bg-gray-50" dir="rtl">
      ...
      <main className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg shadow mb-8">
          <div className="p-6">
            <h2 className="text-lg font-medium text-gray-900 mb-4">إدارة النظام</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <button className="flex flex-col items-center p-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
                ...
                <span className="text-sm font-medium text-gray-900">مراجعة التقارير</span>
              </button>
              ...
              <button className="flex flex-col items-center p-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
                ...
                <span className="text-sm font-medium text-gray-900">إحصائيات النظام</span>
              </button>
              ...
              <button className="flex flex-col items-center p-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
                ...
                <span className="text-sm font-medium text-gray-900">إعدادات النظام</span>
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="p-6">
            <h2 className="text-lg font-medium text-gray-900 mb-4">حالة النظام</h2>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-gray-600">خدمة التحليل الذكي</span>
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-gray-600">خدمة التخزين</span>
                <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                  نشط
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-gray-600">أنظمة النسخ الاحتياطي</span>
                <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                  نشط
                </span>
              </div>
