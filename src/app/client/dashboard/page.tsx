    ...
    <div className="min-h-screen bg-gray-50" dir="rtl">
      ...
      <main className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="mr-4">
                <p className="text-sm font-medium text-gray-600">طلبات الفحص</p>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="mr-4">
                <p className="text-sm font-medium text-gray-600">فحوصات مكتملة</p>
                <p className="text-2xl font-semibold text-gray-900">0</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <button className="flex flex-col items-center p-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
                ...
                <span className="text-sm font-medium text-gray-900">طلب فحص جديد</span>
              </button>
              ...
              <button className="flex flex-col items-center p-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
                ...
                <span className="text-sm font-medium text-gray-900">المهندسين</span>
              </button>
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="p-6">
            <h2 className="text-lg font-medium text-gray-900 mb-4">النشاط الأخير</h2>
            <div className="text-center py-8 text-gray-500">
              ...
              <p className="text-sm">ابدأ بطلب فحص جديد لرؤية النشاط هنا</p>
            </div>
          </div>
        </div>
      </main>
