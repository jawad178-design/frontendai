    ...
    <div className="min-h-screen bg-gray-50" dir="rtl">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-gray-900">لوحة تحكم الشريك</h1>
            </div>
            <div className="flex items-center space-x-4 space-x-reverse">
              <span className="text-gray-700">مرحبا، {user.first_name}</span>
              <div className="h-8 w-8 bg-purple-600 rounded-full flex items-center justify-center">
                <span className="text-white text-sm font-medium">
                  {user.first_name?.charAt(0) || 'ش'}
                </span>
              </div>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="mr-4">
                <p className="text-sm font-medium text-gray-600">المهندسين المسجلين</p>
                <p className="text-2xl font-semibold text-gray-900">0</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="mr-4">
                ...
                <p className="text-2xl font-semibold text-gray-900">0 ر.س</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow mb-8">
          <div className="p-6">
            <h2 className="text-lg font-medium text-gray-900 mb-4">إدارة الشراكة</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <button className="flex flex-col items-center p-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
                ...
                <span className="text-sm font-medium text-gray-900">إضافة مهندس</span>
              </button>
              ...
              <button className="flex flex-col items-center p-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
                ...
                <span className="text-sm font-medium text-gray-900">إدارة المشاريع</span>
              </button>
              ...
              <button className="flex flex-col items-center p-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
                ...
                <span className="text-sm font-medium text-gray-900">إعدادات الشراكة</span>
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="p-6">
            <h2 className="text-lg font-medium text-gray-900 mb-4">أداء الشراكة</h2>
            <div className="text-center py-8 text-gray-500">
              ...
              <p className="mt-2">لا توجد بيانات للعرض</p>
              <p className="text-sm">ابدأ نشاطك في المنصة لرؤية إحصائيات أدائك</p>
            </div>
          </div>
        </div>
      </main>
